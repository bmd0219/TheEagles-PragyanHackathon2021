...
import { register } from "../../../redux/student/login/loginActions";
...
export default function LoginForm() {
    ...
    const handleChangeRollno = e => setRollno(e.target.value);
    ...
    const submitForm = async e => {
        e.preventDefault();
        const user = { email, name, department, password, date, month, year, address, rollno };
